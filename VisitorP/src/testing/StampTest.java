...
class StampTest {
    @Test
    public void testVisitorWithStamp() {
        SignatureWithStamp signature1 = new SignatureWithStamp("sig1", "stamp1");
        SignatureWithStamp signature2 = new SignatureWithStamp("sig2", "stamp2");
        SignatureWithStamp signature3 = new SignatureWithStamp("sig3", "stamp3");
        ...
        assertEquals("stamp1", signature1.getStamp());
        assertEquals("stamp2", signature2.getStamp());
        assertEquals("stamp3", signature3.getStamp());
    }
    ...
    public void testGroup() {
        ...
        assertEquals(2, group1.getTasks().size());
        assertEquals(2, group2.getTasks().size());
        assertEquals(1, group3.getTasks().size());
    }
}
